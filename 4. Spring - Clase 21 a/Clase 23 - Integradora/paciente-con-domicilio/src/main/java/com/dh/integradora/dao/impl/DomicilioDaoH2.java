...
public class DomicilioDaoH2 implements IDao<Domicilio> {
    ...
    public Domicilio guardar(Domicilio domicilio) {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("INSERT INTO domicilios(id,calle,numero,localidad,provincia) VALUES(?,?,?,?,?)",Statement.RETURN_GENERATED_KEYS);
            ...
            if(keys.next())
                domicilio.setDomicilioID(keys.getInt(1));

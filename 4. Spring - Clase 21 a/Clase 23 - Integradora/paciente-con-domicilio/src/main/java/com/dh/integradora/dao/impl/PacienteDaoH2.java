...
import com.dh.integradora.util.Util;
...
public class PacienteDaoH2 implements IDao<Paciente> {
    ...
    public Paciente guardar(Paciente paciente) {
        ...
        try {
            ...
            paciente.getDomicilio().setDomicilioID(domicilio.getDomicilioID());

            //2 Crear una sentencia especificando que el ID lo auto incrementa la base de datos y que nos devuelva esa Key es decir ID
            preparedStatement = connection.prepareStatement("INSERT INTO pacientes(nombre,apellido,dni,email,fecha_ingreso," +
            ...
            preparedStatement.setInt(6, paciente.getDomicilio().getDomicilioID());
    ...
    public Paciente buscar(int id) {
        ...
        try {
            ...
            //2 Crear una sentencia
            preparedStatement = connection.prepareStatement("SELECT id,nombre,apellido,dni,email,fecha_ingreso," +
                    "domicilio_id  FROM pacientes where id = ?");
            preparedStatement.setInt(1,id);
            ...
            while (result.next()) {
                ...
                paciente = new Paciente(idPaciente,apellido,nombre,email,dni
                        ,fechaIngreso,domicilio);
            }
    ...
    public List<Paciente> buscarTodos() {
        ...
        try {
            ...
            //4 Obtener resultados
            while (result.next()) {
                long idPaciente = result.getInt("id");
                String nombre = result.getString("nombre");
                String apellido = result.getString("apellido");
                String email = result.getString("email");
                String dni = result.getString("dni");
                ...
                //Con el domicilio_id traemos el domicilio de la tabla domicilio a traves de DAO de Domicilios
                Domicilio domicilio = domicilioDaoH2.buscar(idDomicilio);
                Paciente paciente = new Paciente(idPaciente,apellido,nombre,email,dni
                ,fechaIngreso,domicilio);

...
public class EstudianteService implements IEstudianteService {
    ...
    @Override
    public void eliminarEstudiante(Long id) throws ResourceNotFoundException {
        if(leerEstudiante(id) == null)
            throw new ResourceNotFoundException("No existe un estudiante con id "+id);

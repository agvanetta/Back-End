package com.backend.proyectointegrador.controllers.impl;
...
import com.backend.proyectointegrador.service.impl.auth.UsuarioService;
...
public class UsuarioController {
    ...
    public ResponseEntity<Usuario> crear(@RequestBody Usuario u) throws BadRequestException {
    ...
    @GetMapping("/403")
    public String error() {
        return "<h1>Error 403: Acceso denegado</h1>";
    }
}
